...
2. To access the Web GUI, you need to run either "python -m streamlit run FinalProject.py" OR "py -m streamlit run FinalProject.py" (py -m streamlit run FinalProject.py worked for me)
3. Upload an image with a digit handwritten in the form of either PNG, JPG, or JPEG)
